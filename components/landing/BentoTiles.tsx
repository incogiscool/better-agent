    ...
    >
      {SSE_EVENTS.slice(0, n).map((e, i) => (
        <div
          ...
          style={{
            animation: i === n - 1 ? "fadeIn 200ms ease-out" : undefined,
          }}
        >
          <span className="text-[oklch(0.50_0_0)] w-[42px] shrink-0">
            {e.ts}
          </span>
    ...
    <div className="w-full grid grid-cols-3 gap-1.5">
      {items.map((it) => (
        ...
        >
          ...
          {it.live ? (
            <span className="text-[9px] px-[5px] py-px rounded-full bg-[oklch(0.65_0.17_145/14%)] text-[oklch(0.55_0.17_145)]">
              SHIPPED
            </span>
          ) : (
  ...
  return (
    <div className="w-full rounded-[var(--radius-md)] p-[12px_14px] bg-[oklch(0.145_0_0)] border border-[oklch(1_0_0/10%)] font-mono text-[oklch(0.985_0_0)] text-[11.5px] leading-[1.7] flex flex-col gap-0.5">
      <div className="flex items-center gap-1.5 mb-1">
        <span
          className="inline-flex items-center gap-[5px] px-2 py-px rounded-full border text-[10.5px]"
          style={{
            background:
              "color-mix(in oklch, oklch(0.769 0.188 70.08) 15%, transparent)",
            borderColor:
              "color-mix(in oklch, oklch(0.769 0.188 70.08) 30%, transparent)",
        ...
        >
          <span
            ...
            style={{
              fontSize: 7,
              background:
                "linear-gradient(135deg, oklch(0.65 0.17 50), oklch(0.40 0.10 35))",
            }}
          >
            AR
          </span>
        ...
        <span className="text-[oklch(0.50_0_0)] text-[10px]">
          campaigns:write
        </span>
      </div>
      <div>
        ...
        {`{ user } = `}
        <span className="text-[oklch(0.985_0_0)]">auth()</span>
      </div>
      ...
      <div className="border-t border-dashed border-[oklch(1_0_0/10%)] mt-1.5 pt-1.5 text-[10px] text-[oklch(0.55_0_0)]">
        <span className="text-[oklch(0.769_0.188_70.08)]">✓</span> No service
        accounts · No scope leaks
      </div>
    </div>
  );
}
  ...
  return (
    <div className="w-full flex flex-col gap-[5px] font-mono text-[11px]">
      {reqs.map((r, i) => (
        <div
          key={i}
          className="flex items-center gap-2 p-[6px_10px] border border-border bg-background rounded-[var(--radius-sm)]"
        >
          ...
          <span className="text-muted-foreground text-[10px] w-7 text-right">
            {r.ms}
          </span>
        </div>
      ))}
  ...
  return (
    <div className="w-full flex flex-col gap-2 font-mono text-[11px]">
      <div className="flex justify-between">
        ...
        <span className={isHot ? "text-destructive" : "text-muted-foreground"}>
          {count}/20 req/min
        </span>
      </div>
      <div className="h-[5px] bg-muted rounded-full overflow-hidden">
        <div
          className={cn(
            "h-full rounded-full transition-[width,background] duration-[800ms]",
